...
if __name__ == "__main__":
    ...
    try:
        scoreboard = Scoreboard("Huh?", "http://140.112.175.18:5000")
        #myScoreboard = ScoreboardFake("TeamName","fakeUID.csv")
        time.sleep(3)
        ...
        print("score:", scoreboard.get_current_score())
        #myScoreboard.add_UID("61C9931C")
        #myScoreboard.add_UID("D1874019")
        #myScoreboard.add_UID("50335F7E")
        #print("score:", myScoreboard.get_current_score())
